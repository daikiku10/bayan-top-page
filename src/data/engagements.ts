...
export const engagements: Engagement[] = [
  {
    ...
    role: "",
    description:
      "企業の情報システム部門向けに、SaaS利用状況の可視化とアカウント管理業務の効率化を実現するSaaS管理プロダクトの新機能開発プロジェクト。社内で利用されるSaaSツールの増加に伴うアカウント管理やシャドーIT（未把握のツール使用）によるセキュリティリスク対応の負荷増大という課題を背景に、営業担当が顧客ヒアリングを通じて収集した要望をもとに機能仕様を検討・設計し、新機能を実装した。",
    tags: [],
  },
  {
    id: "3",
